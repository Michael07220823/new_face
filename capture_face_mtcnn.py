...
with AutoTimer("Capture face", 0):
    ...
    ap.add_argument("-a", "--alignment", required=False, type=str, default="false", help="Turn on/off face alignment, only capture frame. value: true or false")
    ...
    # Image.
        ...
        try:
            ...
            if args["alignment"] != "false":
                roi, raw_image, face_images = face_alignment.mtcnn_alignment(mtcnn_detector,
                                                                            image,
                                                                            conf_threshold=0.9)
            else:
                roi, raw_image, face_images = face_alignment.mtcnn_alignment(mtcnn_detector,
